...
export const metadata = {
  title: "Privacy Policy | Crisper",
  description: "Privacy Policy for Crisper app, developed by Junaid Gandhi (Eclectik Devs)."
};

export default function Page() {
  return (
    <PolicyLayout title="Privacy Policy for Crisper">
      <p>
      ...
      <p>
        ...
        trends for the Service.
        <br />
        These tools collect information sent by your device or our Service,
        including the WORDS you've liked this assists us in improving the
      ...
      <h3>Advertisements Information:</h3>
      <p>
